...
export function useCreateActionCard() {
  ...
  return useMutation({
    mutationFn: async (data: { title_pt: string; title_en: string; severity: string; icon: string; capability?: string; business_process_id?: string }) => {
...
export function useUpdateActionCard() {
  ...
  return useMutation({
    mutationFn: async ({ id, ...data }: { id: string; title_pt: string; title_en: string; severity: string; icon: string; capability?: string; business_process_id?: string }) => {
