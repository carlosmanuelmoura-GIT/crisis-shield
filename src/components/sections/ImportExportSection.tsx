    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <ImportCard
          ...
          importKey="bia"
          hint={t(
            "Colunas: Nome_PT, Nome_EN, Descricao, RTO, RPO, Tipo_BIA (vital/decisao/analitica), DR_Type_ID/DR_Type_Nome, Business_Process_ID/Business_Process_Nome, Departamento_ID/Departamento_Nome, Plataformas, Action_Cards (nomes separados por ;)",
            "Columns: Nome_PT, Nome_EN, Descricao, RTO, RPO, Tipo_BIA (vital/decisao/analitica), DR_Type_ID/DR_Type_Nome, Business_Process_ID/Business_Process_Nome, Departamento_ID/Departamento_Nome, Plataformas, Action_Cards (names separated by ;)"
          )}
        />
        <ImportCard
          icon={Users}
